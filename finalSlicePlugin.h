 ...
 */
#ifndef TRT_FINAL_SLICE_PLUGIN_H
#define TRT_FINAL_SLICE_PLUGIN_H
...
namespace nvinfer1
{
  namespace plugin
  {
    ...
    public:
      ...
      FinalSlice(const void* buffer, size_t length);

      ~FinalSlice() override = default;
    ...
    {
    public:
      FinalSlicePluginCreator();

      ~FinalSlicePluginCreator() override;

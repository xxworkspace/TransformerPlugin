 ...
 */
#ifndef TRT_EMBEDDING_PLUGIN_H
#define TRT_EMBEDDING_PLUGIN_H
...
namespace nvinfer1
{
  namespace plugin
  {
    ...
    class Embedding : public IPluginV2DynamicExt
    {
    public:
      Embedding(const Weights gamma,const DimsHW shape);

      Embedding(const Embedding&);

      Embedding(const void* buffer, size_t length);
    ...
    public:
      ...
      ~EmbeddingPluginCreator() override;
